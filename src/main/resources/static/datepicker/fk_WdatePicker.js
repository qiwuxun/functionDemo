    ...
    function I(G, _) {
        ...
        function B(J) {
            ...
            var I = W(D),
                ...
                A = $dp.dd.offsetWidth;
            if (isNaN(C)) C = 0;
            if (($.topM + I.bottom + G > E.height) && ($.topM + I.top - G > 0)) C +=  $.topM + I.top - G - 2;
            else {
                C =  $.topM + I.bottom;
                var _ = C  + G - E.height;
                if (_ > 0) C -= _
